...
import { ShareInfo, ShareInfoForResponse, ShareInfoId } from "..";

import { ReturnWith, getMyShareList } from "@/api/request/requests";

import "./sharingMy.css";
        ...
        <FloatWrapper>
            <PageWithBackButton>
                {!loadingLoadMyShareDataQuery && shareList.length === 0 ? (
                    ...
                    <div className="sharing-menu sharing-my-menu">
                        <div className="search-input-area">
                            <b className="sharing-my-menu-title">
                                <HeartIcon className="icon" />내 나눔 리스트
                            </b>
